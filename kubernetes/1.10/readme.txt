...
# docker ExecStart=/usr/bin/dockerd --exec-opt native.cgroupdriver=systemd

sed -i "s/\/usr\/bin\/dockerd/\/usr\/bin\/dockerd --exec-opt native.cgroupdriver=systemd/g" /lib/systemd/system/docker.service

# kubelet ExecStart=/usr/bin/kubelet --pod-infra-container-image=registry.cn-hangzhou.aliyuncs.com/k10/pause-amd64:3.1 --fail-swap-on=false
